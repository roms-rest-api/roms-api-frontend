...
export const useStore = create<State>((set) => ({
  ...
  setBrand: (brand: BrandInfo) =>
    set({ selectedBrand: brand, selectedDevice: null }),
  setDevice: (device: Device) => set({ selectedDevice: device }),
}));
